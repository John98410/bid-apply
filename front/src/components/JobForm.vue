...
<input id="title" v-model.trim="form.title" type="text" placeholder="e.g., Frontend Engineer" :disabled="loading" />
...
<textarea id="description" v-model.trim="form.description" rows="6" placeholder="Paste the JD here..." :disabled="loading"></textarea>
...
<textarea id="note" v-model.trim="form.note" type="text" rows="6" placeholder="Any extra note for customizing resume" :disabled="loading" />
...
button.ghost { background: transparent; color: #111827; border: 1px solid #111827; }
.ok { color: #166534; margin-top: 0.75rem; }
.err { color: #b91c1c; margin-top: 0.75rem; }
</style>
